...
class AddTakeBusiness extends StatefulWidget {
  const AddTakeBusiness({super.key});

  @override
  State<AddTakeBusiness> createState() => _AddTakeBusinessState();
}

class _AddTakeBusinessState extends State<AddTakeBusiness> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CommonAppBar(title: "B.recever",),
      body: Padding(
